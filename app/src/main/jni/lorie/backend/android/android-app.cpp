...
public:
	...
	struct xkb_rule_names xkb_names = {nullptr};
...
#define JNI_DECLARE(classname, methodname) \
     JNI_DECLARE_INNER(top_vrcode_app, classname, methodname)
...
JNI_DECLARE(LorieService, createLorieThread)(JNIEnv *env, jobject __unused instance, jstring CustXdgpath) {
	...
	const char *pathx = env->GetStringUTFChars(CustXdgpath, nullptr);
